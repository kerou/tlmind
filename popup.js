...
function  popup(i__text,i__title,i__seconds){
	...
	$('body').append("<div id='"+popupid+"' class='popup' style='bottom:"+popup_bottom+"px'><h1>"+l__title+"<img popupid='"+popupid+"' class='imgpopup' src='img/cross-small.png'/></h1><p>"+i__text+"</p></div>");
